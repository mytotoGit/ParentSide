...
import com.ishuinzu.parentside.adapter.ScreenshotAdapter;
...
import com.ishuinzu.parentside.databinding.FragmentScreenshotsBinding;
...
public class ScreenshotsFragment extends Fragment {
    ...
    public static ScreenshotsFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentScreenshotsBinding.inflate(inflater);
    ...
    private void loadLiveLocks(String id, String parentID) {
        screenshotObjects = new ArrayList<>();
        keys = new ArrayList<>();
        screenshotAdapter = new ScreenshotAdapter(getContext(), screenshotObjects, keys);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        linearLayoutManager.setReverseLayout(true);
        binding.recyclerScreenshots.setAdapter(screenshotAdapter);
        binding.recyclerScreenshots.setLayoutManager(linearLayoutManager);
                        ...
                        if (snapshot.getChildrenCount() != 0) {
                            for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                                if (dataSnapshot != null) {
                                    ScreenshotObject screenshotObject = dataSnapshot.getValue(ScreenshotObject.class);

                                    if (screenshotObject != null) {
                                        screenshotObjects.add(screenshotObject);
