package com.ishuinzu.parentside.widget.datetimepicker.view.datePicker;
...
import com.ishuinzu.parentside.widget.datetimepicker.factory.DateFactoryListener;
import com.ishuinzu.parentside.widget.datetimepicker.factory.DatePickerFactory;
import com.ishuinzu.parentside.widget.datetimepicker.model.DateModel;
import com.ishuinzu.parentside.widget.datetimepicker.view.WheelView;
...
public class DatePicker extends LinearLayout implements DateFactoryListener {
    ...
    private int textSizeInteger = 19;
    ...
    private void setAttributes(Context context, @Nullable AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            } else if (attr == R.styleable.Picker_textSizeInteger) {
                this.textSizeInteger = Math.min(a.getInt(attr, MAX_TEXT_SIZE), MAX_TEXT_SIZE);
    ...
    private void setupEmptyViews() {
        ...
        emptyView1.setTextSize(textSizeInteger);
        emptyView2.setTextSize(textSizeInteger);
    ...
    private void setUpYearView() {
        ...
        yearView.setTextSize(textSizeInteger);
    ...
    private void setUpMonthView() {
        ...
        monthView.setTextSize(textSizeInteger);
    ...
    private void setUpDayView() {
        ...
        dayView.setTextSize(textSizeInteger);
    ...
    public void setTextSizeInteger(int textSizeInteger) {
        this.textSizeInteger = Math.min(textSizeInteger, MAX_TEXT_SIZE);
        setUpCalendar();
    }
