package com.ishuinzu.parentside.widget.datetimepicker.view.timePicker;
...
import com.ishuinzu.parentside.widget.datetimepicker.factory.TimeFactory;
import com.ishuinzu.parentside.widget.datetimepicker.factory.TimeFactoryListener;
...
public class TimePicker extends LinearLayout implements TimeFactoryListener {
    ...
    private View createMinuteView(Context context) {
        ...
        minuteView.setTextSize(textSizeInteger);
    ...
    private View createHourView(Context context) {
        ...
        hourView.setTextSize(textSizeInteger);
