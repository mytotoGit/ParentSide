package com.ishuinzu.parentside.widget;
...
public class ArcProgress extends View {
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        setProgress(attributes.getFloat(R.styleable.ArcProgress_arc_progress, 5));
    ...
    protected void initPainters() {
        ...
        textPaint.setTypeface(getResources().getFont(R.font.nova_round));
